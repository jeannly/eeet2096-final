...
GPIO_Config tx_uart_config = {
    .port = ((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)),
    .pin = Pin10,
...
GPIO_Config light_switch_config = {
    .port = ((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)),
    .pin = Pin9,
    .mode = GPIO_Input,
    .pullUpDown = GPIO_No_Pull,
    .outputType = GPIO_Output_PushPull, 
...
GPIO_Config thermometer_config = { 
    .port = ((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1400U)),
    .pin = Pin10,
    .mode = GPIO_AlternateFunction,
    .pullUpDown = GPIO_No_Pull,
    .outputType = GPIO_Output_PushPull, 
...
UARTInterface uart = {
    ...
    .transmit_data = 0,
    .receive_data = 0,
    .is_controlling_ACSystem = 0,
    .tx_config = &tx_uart_config,
    .rx_config = &rx_uart_config,
    .uart = ((USART_TypeDef *) (0x40000000U + 0x4800U))};
...
int main(void)
{
  ...
  ((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2RSTR |= (0x1U << (17U));
  __asm("nop");
  __asm("nop");
  ((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1RSTR &= ~((0x1U << (0U)) | (0x1U << (1U)) | (0x1U << (5U)));
  ((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1RSTR &= ~((0x1U << (4U)) | (0x1U << (5U)) | (0x1U << (18U)));
