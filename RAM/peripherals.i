...
typedef enum {GPIO_Input = 0, GPIO_Output, GPIO_AlternateFunction, GPIO_Analog}GPIOMode;																													
...
#line 7 ".\\inc\\peripherals.h"
#line 8 ".\\inc\\peripherals.h"
...
typedef struct Timer {
    _Bool is_running;
    uint16_t time_in_ms;
    _Bool in_one_pulse_mode;
    uint32_t clock_speed;
    TIM_TypeDef * timer_component; 
} Timer;
...
#line 4 "src\\peripherals.c"
#line 5 "src\\peripherals.c"
#line 1 ".\\inc\\CMSIS\\core_cm4.h"
...
#line 220 ".\\inc\\CMSIS\\core_cm4.h"



#line 1937 ".\\inc\\CMSIS\\core_cm4.h"

#line 6 "src\\peripherals.c"

void initUART(UARTInterface *uart_interface)
{
    
    uart_interface->uart->CR1 &= ~((0x1U << (15U)));

    
    uart_interface->uart->BRR &= 0xFFFF0000;
    uart_interface->uart->BRR |= (45 << (4U)) | (9 << (0U));

    
    uart_interface->uart->CR1 &= ~((0x1U << (12U)));

    
    uart_interface->uart->CR2 &= ~((0x3U << (12U)));
    uart_interface->uart->CR2 |= (0 << (12U));

    
    uart_interface->uart->CR1 &= ~((0x1U << (10U)));

    
    uart_interface->uart->CR2 &= ~((0x1U << (11U)) | (0x1U << (10U)) | (0x1U << (9U)));

    
    uart_interface->uart->CR2 &= ~((0x1U << (9U)) | (0x1U << (8U)));

    
    uart_interface->uart->CR1 |= ((0x1U << (5U)));

    
    uart_interface->uart->CR1 |= ((0x1U << (13U)) | (0x1U << (2U)) | (0x1U << (3U)));
    return;
}
